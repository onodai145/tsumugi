...
<!-- Backstage.svelte(ログバー)と隣接して並ぶため、そのバーの外枠(border-t/bg-card)と
     高さ(min-h-6 + pt-[3px] pb-[max(3px,var(--safe-bottom))])を正確に揃える
...
<div
  class="flex min-h-6 flex-none items-center self-end border-t border-border bg-card pt-[3px] pr-1 pb-[max(3px,var(--safe-bottom))] pl-[max(8px,var(--safe-left))]"
>
